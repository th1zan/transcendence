# Generated by Django 5.0.6 on 2025-03-10 12:18
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('notification_type', models.CharField(choices=[('friend_request', 'Friend Request'), ('friend_request_declined', 'Friend Request Declined'), ('game_invite', 'Game Invite')], max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user1', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='initiated_matches', to=settings.AUTH_USER_MODEL)),
                ('user2', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='opponent_matches', to=settings.AUTH_USER_MODEL)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('match', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='sets', to='api.pongmatch')),
            ],
        ),
        migrations.CreateModel(
            name='Tournament',
