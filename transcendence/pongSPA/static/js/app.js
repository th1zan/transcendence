    ...
    <div class="container py-5" font-family: 'Poppins', sans-serif;">
      <div class="row justify-content-center">
        ...
        <div class="col-md-6 d-flex flex-column gap-4">
          <!-- Welcome Card -->
          <div class="card shadow-sm bg-transparent" style="border: none; border-radius: 15px; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1); transition: transform 0.3s ease, box-shadow 0.3s ease;">
